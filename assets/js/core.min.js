...
$(document).ready(function () {
  ...
  $(function () {
    ...
    $(window).scroll(function () {
      ...
      if (scroll >= Number('50')) {
        header.addClass('nav-header-alt');
      } else {
        header.removeClass('nav-header-alt');
      }
    });
  }); // -------------Begin JS for scroll top ------------//
  ...
  $('.social-feed-wrap #loadmore').click(function () {
    $('.social-feed-gap:hidden').slice(0, Number('3')).show();
    $('html,body').animate({
      scrollTop: $('.social-feed-wrap #loadmore').offset().top - Number('100')
    }, Number('1500'), 'swing'); // if($('.social-feed-gap:hidden').length === 0) {
  ...
  wow.init(); // When the user scrolls the page, execute myFunction
  ...
  if (document.querySelector('.client-logo-slide')) {
  ...
  } // Begin JS for Resource Page
  // When the use click siber tab,


  $(document).on('scroll', onScroll); // smoothscroll

  $('.resource-feature-wrap .feature-list a[href^="#"]').on('click', function (e) {
    e.preventDefault();
    $(document).off('scroll');
    $('.resource-feature-wrap .feature-list a').each(function () {
    ...
    $('html, body').stop().animate({
      scrollTop: $target.offset().top - Number('210')
    }, Number('500'), 'swing', function () {
  ...
  function onScroll(event) {
    ...
    $('.resource-feature-wrap .feature-list a').click(function () {
      linkClicked = true;
    });
    $('.resource-feature-wrap .feature-list a').each(function () {
      var currLink = $(this);
      ...
      if (refElement.position().top <= scrollPos && refElement.position().top + refElement.height() > scrollPos) {
        if (!linkClicked) {
          $('.resource-feature-wrap .feature-list a').removeClass('active');
  ...
  } // End JS for Resource Page

});
var stickyOffset;

if (document.querySelector('.sidebar') !== null) {
  stickyOffset = $('.resource .sidebar').offset().top;
}
...
$(window).scroll(function () {
  ...
  if (document.querySelector('.resource .sidebar') !== null) {
    var modelsticky = $('.resource .sidebar');
    var modelscroll = $(window).scrollTop();
    var footerTop = $('.user-manual').offset().top;
    var divHeight = $('.resource .sidebar').height();

    if (modelscroll + divHeight > footerTop) {
      modelsticky.removeClass('stickyBar');
    } else if (modelscroll >= stickyOffset) {
      modelsticky.addClass('stickyBar');
    } else {
      modelsticky.removeClass('stickyBar');
    }
  }
}); // $('.parallax-window').parallax({imageSrc: 'assets/images/uploads/banner-abt-img.jpg'});